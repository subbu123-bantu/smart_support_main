      ...
      <div className="space-y-4 min-h-[300px]">
        ...
        {tickets.map((ticket) => (
          <div
            ...
            className="cursor-pointer bg-white p-5 rounded-xl shadow border hover:shadow-md transition"
          >
              ...
              <div className="text-right">
                ...
                {role === "admin" && (
                  <select
                    ...
                    className="mt-2 border px-2 py-1 rounded text-xs"
                  >
